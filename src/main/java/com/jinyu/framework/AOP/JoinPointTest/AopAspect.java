...
//      获取被增强的类实例
//        ((TargetClass)joinPoint.getTarget()).joint("aa","bb");
//        Class c = joinPoint.getTarget().getClass();
//        Class[] ca = new Class[] {String.class, String.class};
//        Method m = c.getMethod("joint",ca);
//        m.invoke(joinPoint.getTarget(),"aa","bb");
    }
